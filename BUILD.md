...
Directory **`llvm-10.0.1.src\`** is setup as follows:
<pre style="font-size:80%;">
<b>&gt; <a href="https://curl.haxx.se/docs/manpage.html">curl</a> -sL -o llvm-10.0.1.src.tar.xz <a href="https://github.com/llvm/llvm-project/releases/tag/llvmorg-10.0.1">llvm-10.0.1.src.tar.xz</a></b>
<b>&gt; <a href="http://linuxcommand.org/lc3_man_pages/tar1.html">tar</a> xzvf llvm-10.0.1.src.tar.xz</b>
<b>&gt; <a href="https://man7.org/linux/man-pages/man1/cp.1.html">cp</cp> <a href="bin/llvm/build.bat">bin\llvm\build.bat</a> llvm-10.0.1.src</b>
<b>&gt; <a href="https://docs.microsoft.com/en-us/windows-server/administration/windows-commands/cd">cd</a> llvm-10.0.1.src</b>
</pre>

> **:mag_right:** In our case we have the choice between the 3 source directories `llvm-8.0.1.src\`, `llvm-9.0.1.src\` and `llvm-10.0.1.src\`.
...
[build] Current directory is: L:\llvm-10.0.1.src\build
[...]
</pre>
...
> <pre style="font-size:80%;">
> <b>&gt; <a href="https://docs.microsoft.com/en-us/windows-server/administration/windows-commands/where_1">where</a> /r c:\opt\LLVM-10.0.0 llvm*.exe | wc -l</b>
> 14
> </pre>
...
<b>&gt; <a href="https://docs.microsoft.com/en-us/windows-server/administration/windows-commands/where_1">where</a> /t clang llc lld lldb lli opt</b>
  ...
  48576512   29.09.2020      16:17:53  C:\opt\LLVM-10.0.0\bin\llc.exe
  57812480   25.03.2020      12:05:38  C:\opt\LLVM-10.0.0\bin\lld.exe
    226304   25.03.2020      12:07:10  C:\opt\LLVM-10.0.0\bin\lldb.exe
  18974720   29.09.2020      16:18:08  C:\opt\LLVM-10.0.0\bin\lli.exe
  52702720   29.09.2020      16:24:30  C:\opt\LLVM-10.0.0\bin\opt.exe
</pre>
...
[llvm_downloads]: https://github.com/llvm/llvm-project/releases/tag/llvmorg-10.0.1
